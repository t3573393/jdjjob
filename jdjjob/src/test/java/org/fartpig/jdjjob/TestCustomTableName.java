...
public class TestCustomTableName extends TestCase {
	...
	private void assertHandler(String file, String line, String code, String desc) {
		System.out.println(String.format("Assertion failed at %s:%s: %s: %s", file, line, code, desc));
	}
